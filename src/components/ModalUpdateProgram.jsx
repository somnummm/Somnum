...
const ModalUpdateProgram = ({setSleepTime, setWakeTime, setIsUpdateModalOpen, date, entity}) => {
    ...
    ModalUpdateProgram.propTypes = {
        ...
        entity: PropTypes.shape({
            newSleepTime: PropTypes.string.isRequired,
            newWakeTime: PropTypes.string.isRequired,
        }).isRequired,
    };

    useEffect(() => {
        setNewSleepTime(
            new Date(entity.newSleepTime).toLocaleTimeString([], {
                hour: "2-digit",
                minute: "2-digit",
            })
        );
        setNewWakeTime(
            new Date(entity.newWakeTime).toLocaleTimeString([], {
                hour: "2-digit",
                minute: "2-digit",
            })
        );
