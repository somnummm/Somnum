...
const Profile = () => {
    ...
    useEffect( () => {
        async function fetchData(){
            await loadSleepInfo(new Date().toLocaleDateString()).then((response) => {
        ...
        <>
            ...
            <div className="relative border border-solid border-purple-900 rounded-lg p-2 mx-4 shadow-xl">
                ...
                <div className="relative z-10 text-white">
                    ...
                    <br/>
                    {wakeTime && sleepTime ? <div className="blocInfos">
                        <div className="pageInfosParagraphe">
                            Ce soir, vous devez vous coucher à{" "}
                            <p className="text-red-400 font-bold inline">{sleepTime}</p> pour
                            vous réveiller demain à{" "}
                            <span className="text-red-400 font-bold inline">{wakeTime}</span>.
                            <br/>
                            <br/>
                            Vous serez notifié 30 minutes avant d aller dormir.
                        </div>
                    </div> : <div className="pageInfosParagraphe">
                        Pas de données
                    </div>}
                </div>
            </div>
